...
#
# # Internal
# from graphatoms.misc.utilities    import (flatten,safeMkDir,safeMkDirForce,
#                                             running_jobs_sherlock) #type: ignore
# from graphatoms.misc.print_parse  import print_time
#
# """
...
# # CONSTANTS
# ###########
# graphatoms   = environ['GRAPHATOMS_PATH']
# queue        = 'iric'
#
#
...
# ############################################
#
# def test_suite(working_path : str,trajname : str) -> None:
#     """
#     Run a suite of tests on a directory with a traj in it
#     """
#
#     for code,quality in product(codes,qualities):
#         new_path = join(working_path,code,quality)
#         safeMkDirForce(new_path)
#         copyfile(join(working_path,'%s.traj'%trajname)
...
#     """
#
#     def __init__(self,dftcode : str ='gpaw', quality : str = 'low') -> None:
#
#         assert dftcode in ['gpaw','vasp']
#         assert quality in ['low','mid','high']
#
#         #assert 'VASP_VDW_KERNEL' in environ # IF we were to use VASP BEEF functional
#
...
#         copyfile(traj_path,join(analysis_folder,'%s.traj'%trajname))
#
#         return analysis_folder,traj_path
#
#     def _write_metascript(self, analysis_path : str) -> None:
#         """
...
#     #----------------------
#
#     def _generate_charge_density(self,analysis_path : str, atoms_path : str) -> None:
#         """
#         Helpful docstring
#         """
#         # Initialize
...
#                  ,atoms,data=density)
#
#     def _write_chargemol_input(self,analysis_path : str,atoms_path : str) -> None:
#         """
...
#             f.write(job_control)
#
#     def _call_chargemol(self,analysis_path : str ,atoms_path    : str) -> None:
#         """
...
#     #-------------------------
#     def _mk_kpts(self,atoms_path : str) -> List[int]:
#         """
#         Chooses appropriate kpt spacing
#         """
#
#         def get_kpt(x : np.array) -> int:
#             return int(ceil(15/np.linalg.norm(x)))
#
#         cell = read(atoms_path).get_cell() # 3 x 3 array
#
#         return  [get_kpt(v) for v in cell]
#
#     def _mk_gpaw(self,atoms_path : str) -> Any: # ignore return type ... not everyone can import GPAW
#         """
...
#                                          ,'density':0.01 * scale
#                                          ,'bands':-10})
#     def _mk_vasp(self,atoms_path : str) -> Any: # ignore return type
#         """
...
#
#     def submit(self, working_path : str,trajname  : str) -> None:
#         """
...
#             chdir(analysis_path)
#             system('sbatch %s'%join(analysis_path,'sub_chargemol.sh'))
#
#     def analyze(self,
#                 working_path : str,
#                 trajname     : str,
