...
class BondAnalyzer(object):
    ...
    def _write_script(self,
        ...
        script = '\n'.join([header
                           ,'from graphatoms.chargemol.submitter%s import BondAnalyzer'%if_gpaw
    ...
    def _write_chargemol_input(self,analysis_path ,atoms_path ) :
        """
    ...
    def _call_chargemol(self,analysis_path  ,atoms_path    ) :
        """
    ...
    def _mk_gpaw(self,atoms_path ): # ignore return type ... not everyone can import GPAW
        """
        ...
        return gpaw.GPAW(mode='lcao',basis = 'dzp',mixer=gpaw.Mixer(0.1, 5, 100),
                         ...
                         convergence   = {'energy':0.1 * scale
                                         ,'density':0.01 * scale
                                         ,'bands':-10})
    def _mk_vasp(self,atoms_path ): # ignore return type
        """
